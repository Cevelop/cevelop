...
public class DoNotOmitVirtSpecifierAddOverrideQuickFix extends BaseQuickFix {

    public DoNotOmitVirtSpecifierAddOverrideQuickFix(String label) {
        super(label);
    }
    ...
    protected void handleMarkedNode(IASTNode markedNode, ASTRewrite hRewrite) {
        ...
        newDecl.addVirtSpecifier(factory.newVirtSpecifier(SpecifierKind.Override));
