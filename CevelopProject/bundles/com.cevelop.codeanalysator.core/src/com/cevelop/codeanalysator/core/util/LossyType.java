...
public enum LossyType {
    ...
    private LossyType(final String msg) {
        this.msg = msg;
    }
    ...
    public static LossyType lossyType(String type1, String type2, boolean functionArgumentVariant) {
        ...
        case "long double->unsigned long long int":
