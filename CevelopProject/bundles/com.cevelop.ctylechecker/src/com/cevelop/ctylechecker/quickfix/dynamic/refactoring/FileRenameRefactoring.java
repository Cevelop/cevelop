...
public class FileRenameRefactoring extends AbstractRenameRefactoring {

    IFile file;

    public FileRenameRefactoring(IFile pFile) {
        file = pFile;
    }
    ...
    String postProcessName(String transformedName) {
        if (!file.getFileExtension().isEmpty()) {
            transformedName += "." + file.getFileExtension();
        }
    ...
    protected Optional<String> getOriginalName() {
        return FileUtil.extractFileName(file);
    }
