package com.cevelop.gslator.nodes.util;
...
public class AttributeOwnerHelper {
    ...
    public static final List<Class> invalidAttributeOwners = new ArrayList<>(Arrays.asList(ICPPASTNamedTypeSpecifier.class,
            ICPPASTCatchHandler.class));

    public static final List<Class> unwantedAttributeOwners = new ArrayList<>(Arrays.asList(ICPPASTFunctionDeclarator.class, ICPPASTDeclarator.class,
            IASTDeclarationStatement.class, IASTEnumerator.class));
