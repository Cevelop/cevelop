...
public class ES09_02AvoidALLCAPSnamesCheckerTestWithMacroMarkers extends BaseCheckerTest {
    ...
    protected void problemPreferenceSetup(RootProblemPreference preference) {
        ...
        preference.setChildValue(ES09AvoidALLCAPSnamesChecker.PREF_MARK_MACROS, true);
    }
}
