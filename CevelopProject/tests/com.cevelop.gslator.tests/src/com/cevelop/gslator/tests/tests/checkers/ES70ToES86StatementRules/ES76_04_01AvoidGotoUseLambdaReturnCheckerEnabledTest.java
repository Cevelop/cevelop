...
public class ES76_04_01AvoidGotoUseLambdaReturnCheckerEnabledTest extends BaseCheckerTest {
    ...
    protected void problemPreferenceSetup(RootProblemPreference preference) {
        ...
        preference.setChildValue(ES76AvoidGotoChecker.PREF_MULTIBREAK, true);
    }
}
