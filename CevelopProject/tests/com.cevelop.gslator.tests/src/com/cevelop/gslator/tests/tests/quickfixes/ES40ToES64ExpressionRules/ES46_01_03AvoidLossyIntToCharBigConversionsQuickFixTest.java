...
public class ES46_01_03AvoidLossyIntToCharBigConversionsQuickFixTest extends ES46_00AvoidLossyConversionsQuickFixTest {
    ...
    protected ES46LossyType getLossyType() {
        return ES46LossyType.IntToCharBig;
    }
}
