...
public class ES46_01_08AvoidLossySignedToUnsignedFunctionArgumentConversionsQuickFixTest extends ES46_00AvoidLossyConversionsQuickFixTest {
    ...
    protected ES46LossyType getLossyType() {
        return ES46LossyType.ToUnsignedFunc;
    }
}
