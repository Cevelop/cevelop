...
public class ES46_02_07AvoidLossySignedToUnsignedConversionsQuickFixTest extends ES46_00AvoidLossyConversionsQuickFixTest {
    ...
    protected ES46LossyType getLossyType() {
        return ES46LossyType.ToUnsigned;
    }
}
