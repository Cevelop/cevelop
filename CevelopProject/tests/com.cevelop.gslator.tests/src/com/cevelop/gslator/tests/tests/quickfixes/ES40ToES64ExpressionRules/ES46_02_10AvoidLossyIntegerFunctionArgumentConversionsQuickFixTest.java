...
public class ES46_02_10AvoidLossyIntegerFunctionArgumentConversionsQuickFixTest extends ES46_00AvoidLossyConversionsQuickFixTest {
    ...
    protected ES46LossyType getLossyType() {
        return ES46LossyType.IntegerFunc;
    }
}
