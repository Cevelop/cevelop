...
public class CommentHandlingTest1LineCommentSameLine extends IncludatorTest {
    ...
    public void runTest() throws Throwable {
        ...
        assertSuggestion(suggestions.get(0), "main.cpp", "The include statement '#include \"foo.h\"' is unneeded. No reference requires include.", 0,
                20);
    }
}
