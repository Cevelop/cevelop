...
public class ProjectCoverageTest18FieldConstrDestr2 extends IncludatorTest {
    ...
    public void runTest() throws Throwable {
        ...
        assertSuggestion(suggestions.get(i++), "A.cpp", inUseText, 132, 34); // int main() {
        assertSuggestion(suggestions.get(i++), "A.cpp", notInUseText, 0, 7); // class Y
        ...
        assertSuggestion(suggestions.get(i++), "A.cpp", notInUseText, 98, 4); // Y y;
