...
public class ProjectCoverageTest31ImplicitlyUsed3 extends IncludatorTest {

    @Test
    public void runTest() throws Throwable {
        List<Suggestion<?>> suggestions = runAlgorithm(new StaticCoverageProjectAnalysisAlgorithm());

        Assert.assertEquals((Object) 13, (Object) suggestions.size());
        ...
        int i = 0;
        assertSuggestion(suggestions.get(i++), "X.h", implicitlyInUseText, 61, 4); // Z z;
