...
public class ProjectCoverageTest44Enumerator extends IncludatorTest {
    ...
    public void runTest() throws Throwable {
        ...
        assertSuggestion(suggestions.get(i++), "main.cpp", inUseText, 35, 60); // int main(int argc, char **argv) {
    }
}
