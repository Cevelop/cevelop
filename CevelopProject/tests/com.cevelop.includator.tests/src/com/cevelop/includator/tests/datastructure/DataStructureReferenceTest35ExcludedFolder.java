...
public class DataStructureReferenceTest35ExcludedFolder extends IncludatorTest {
    ...
    public void runTest() throws Throwable {
        ...
        store.setValue(IncludatorPropertyManager.EXCLUDE_RESOURCES_PROPERTY_NAME, "lib");

        Assert.assertEquals((Object) 1, (Object) getActiveProject().getAffectedFiles().size());
    }
}
