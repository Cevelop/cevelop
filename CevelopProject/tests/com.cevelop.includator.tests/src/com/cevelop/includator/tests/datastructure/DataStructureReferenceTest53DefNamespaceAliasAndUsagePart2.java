...
public class DataStructureReferenceTest53DefNamespaceAliasAndUsagePart2 extends IncludatorTest {
    ...
    private void checkMainCppRefs() throws IOException {
        ...
        assertDeclaration(getRequiredDependency(myNSRef).getDeclaration(), "alias.h", "myNS", 35);
