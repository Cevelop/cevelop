...
public class ConstructorRefTest12ExplConstrExplSubConstr2 extends IncludatorTest {
    ...
    public void runTest() throws Throwable {
        ...
        ConstructorDeclarationReference zCopyConstrRef = getConstructorReference(references.get(3));
        ...
        ConstructorDeclarationReference zConstrRef = getConstructorReference(references.get(8));
