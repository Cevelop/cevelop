...
public class ConstructorRefTest17BaseClassConstructor2 extends IncludatorTest {
    ...
    public void runTest() throws Throwable {
        ...
        SpecialMemberFunctionDeclarationReference aConstrRef = getConstructorReference(references.get(1));
        Assert.assertTrue(aConstrRef.isOnlyReferenceName());
        assertDeclarationReference("A", "B.cpp", 18, aConstrRef);
        assertNodeSignature("B", aConstrRef.getASTNode());// the helper name is the constructor definition of B
        assertDeclaration(getRequiredDependency(aConstrRef).getDeclaration(), "A.h", "A", 20);
    }
