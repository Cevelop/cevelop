...
public class ConstructorRefTest6 extends IncludatorTest {
    ...
    public void runTest() throws Throwable {
        ...
        DeclarationReference constructorRef = references.get(4);
        assertDeclRefName("X", constructorRef);
        assertNodeSignature("x", constructorRef.getASTNode());
        assertDeclaration(getRequiredDependency(constructorRef).getDeclaration(), "X.h", "X", 6);
    }
}
