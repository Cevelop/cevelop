...
public class HelperTest10ExternalTuProviderTest extends IncludatorTest {
    ...
    public void runTest() throws Throwable {
        IFile file = externalTestResourcesHolder.getFile("externalFrameworkTest/QWER.h");
        TranslationUnitProvider tuProvider = new TranslationUnitProvider(file);
        ...
        Assert.assertEquals(file.getRawLocation().toOSString(), ast.getFilePath());
    }
}
