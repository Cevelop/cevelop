...
public class IncludeToFwd11IncludeToInexistingHeader extends IncludatorTest {
    ...
    public void runTest() throws Throwable {
        ...
        assertSuggestion(suggestion, "main.cpp", "#include \"A.h\" can be replaced with forward declaration of 'class A'.", 0, 14);
    }
}
