...
public class IncludeToFwd4SeveralPathsOnePossible extends IncludatorTest {
    ...
    public void runTest() throws Throwable {
        ...
        assertSuggestion(suggestion, "main.cpp", "#include \"A.h\" can be replaced with forward declaration of 'class A1'.", 0, 14);
    }
}
