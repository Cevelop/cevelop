...
public class IncludeToFwd7SeveralFwdInSameHeader extends IncludatorTest {
    ...
    public void runTest() throws Throwable {
        ...
        assertSuggestion(suggestion, "main.cpp", "#include \"A.h\" can be replaced with forward declarations of 'class A1', 'class A2'.", 0, 14);
    }
}
