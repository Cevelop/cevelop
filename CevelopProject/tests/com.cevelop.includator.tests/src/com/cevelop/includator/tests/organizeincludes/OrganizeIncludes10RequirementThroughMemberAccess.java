...
public class OrganizeIncludes10RequirementThroughMemberAccess extends IncludatorTest {
    ...
    public void runTest() throws Throwable {
        ...
        assertSuggestion(suggestions.get(0), "main.cpp", "The include statement '#include \"A.h\"' is unneeded. Covered through: B.h", 0, 14);
    }
}
