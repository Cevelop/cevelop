...
public class OrganizeIncludes1Simple extends IncludatorTest {
    ...
    public void runTest() throws Throwable {
        ...
        assertSuggestion(suggestions.get(0), "main.cpp", "Missing '#include \"C.h\"'.", 29, 1);
        assertSuggestion(suggestions.get(1), "main.cpp", "The include statement '#include \"A.h\"' is unneeded. No reference requires include.", 0,
                14);
    }
}
