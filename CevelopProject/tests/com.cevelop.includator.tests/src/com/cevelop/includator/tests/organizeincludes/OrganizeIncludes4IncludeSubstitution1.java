...
public class OrganizeIncludes4IncludeSubstitution1 extends IncludatorTest {
    ...
    public void runTest() throws Throwable {
        ...
        assertSuggestion(suggestions.get(0), "main.cpp", "Missing '#include <vector>'.", 0, 1);
        assertQuickFix("Add '#include <vector>'.", 0, 1, suggestions.get(0));
    }
}
