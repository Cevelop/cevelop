...
public class StartingPointTest2FolderScope extends IncludatorTest {

    @Test
    public void runTest() throws Throwable {
        AlgorithmScope scope = AlgorithmScope.CONTAINER_SCOPE;
        ...
        assertFileNames(affectedFiles, makeOSPath("folder1/a.cpp"), makeOSPath("folder1/b.cpp"), makeOSPath("folder1/subfolder/c.cpp"));
    }
}
