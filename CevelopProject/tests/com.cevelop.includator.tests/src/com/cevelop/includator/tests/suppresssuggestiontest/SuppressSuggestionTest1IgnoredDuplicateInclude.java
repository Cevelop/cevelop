...
public class SuppressSuggestionTest1IgnoredDuplicateInclude extends IncludatorTest {
    ...
    public void runTest() throws Throwable {
        ...
        String expectedMsg =
                           "Prevented adding of suggestion 'The include statement '#include \"A.h\"' is unneeded. Duplicate include.' caused by entry in Suppress-Suggestion list (see project properties).";
