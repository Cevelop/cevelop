...
public class SuppressSuggestionTest8OneIgnoredAndOneSuggestedMissingInclude extends IncludatorTest {
    ...
    public void runTest() throws Throwable {
        ...
        assertSuggestion(suggestions.get(0), "main.cpp", "Missing '#include \"B.h\"'.", 0, 1);
