...
public class SyntaxError1MissingOpeningBracket extends IncludatorTest {
    ...
    public void runTest() throws Throwable {
        ...
        Suggestion<?> suggestion1 = suggestions.get(0);
        Assert.assertEquals("The include statement '#include \"C.h\"' is unneeded. No reference requires include.", suggestion1.getDescription());
    }
}
