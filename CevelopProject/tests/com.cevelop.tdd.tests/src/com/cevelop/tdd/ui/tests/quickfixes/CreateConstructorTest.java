...
import com.cevelop.tdd.quickfixes.create.function.constructor.CreateConstructorQuickfix;

import ch.hsr.ifs.iltis.cpp.core.ast.checker.helper.IProblemId;
import ch.hsr.ifs.iltis.cpp.core.codan.marker.InfoProblemMarkerResolutionGenerator;


public class CreateConstructorTest extends AbstractQuickFixTest<InfoProblemMarkerResolutionGenerator> {
    ...
    protected boolean solutionSelectionPredicate(IMarkerResolution quickfix) {
        return quickfix instanceof CreateConstructorQuickfix;
    }
