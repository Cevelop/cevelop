...
import com.cevelop.tdd.quickfixes.create.namespace.CreateNamespaceQuickfix;

import ch.hsr.ifs.iltis.cpp.core.ast.checker.helper.IProblemId;
import ch.hsr.ifs.iltis.cpp.core.codan.marker.InfoProblemMarkerResolutionGenerator;


public class CreateNamespaceTest extends AbstractQuickFixTest<InfoProblemMarkerResolutionGenerator> {

    @Override
    protected IProblemId<?> getProblemId() {
        return ProblemId.MISSING_NAMESPACE;
    }

    @Override
    protected boolean solutionSelectionPredicate(IMarkerResolution quickfix) {
        return quickfix instanceof CreateNamespaceQuickfix;
    }
