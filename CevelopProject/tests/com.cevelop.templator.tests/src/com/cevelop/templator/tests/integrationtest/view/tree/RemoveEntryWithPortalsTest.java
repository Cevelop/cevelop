...
public class RemoveEntryWithPortalsTest extends TreeViewTest {
    ...
    public void test04_removeEntry_1() throws TemplatorException {
        ...
        expected.add(new TreeViewTestInfo(1, 1, 1, 4, 0));
        expected.add(new TreeViewTestInfo(2, 1, 2, 1, 1));
        expected.add(new TreeViewTestInfo(3, 1, 0, 0, 5));
        expected.add(new TreeViewTestInfo(3, 1, 0, 1, 0));
        assertTreeViewTestInfo(expected);
    }
    ...
    public void test06_checkStates() {
        RectangleStateCollection expected = new RectangleStateCollection();
        expected.addEntry(IDLE, ACTIVE, IDLE);
        expected.addEntry(ACTIVE, IDLE);
        expected.addEntry(IDLE, ACTIVE, IDLE, IDLE, IDLE, IDLE, ACTIVE, ACTIVE);
        expected.addEntry(IDLE, ACTIVE, ACTIVE, ACTIVE, IDLE, ACTIVE, ACTIVE);
        expected.addEntry();
        assertRectangleStates(expected);
    }
    ...
    public void test07_removeEntry_2() throws TemplatorException {
        ...
        expected.add(new TreeViewTestInfo(2, 1, 2, 1, 3));
    ...
    public void test09_checkStates() {
        ...
        expected.addEntry(IDLE, IDLE, ACTIVE, IDLE, ACTIVE, ACTIVE, ACTIVE, ACTIVE);
        expected.addEntry(IDLE, IDLE, IDLE, IDLE, IDLE, ACTIVE, ACTIVE);
        expected.addEntry();
        assertRectangleStates(expected);
    }
    ...
    public void test15_checkStates() {
        ...
        expected.addEntry(ACTIVE, ACTIVE);
        expected.addEntry(ACTIVE, ACTIVE);
        expected.addEntry(IDLE, ACTIVE, ACTIVE, IDLE, ACTIVE, ACTIVE, IDLE, ACTIVE);
        expected.addEntry();
        assertRectangleStates(expected);
    }
    ...
    @Test
    public void test07_removeEntry_0() throws TemplatorException {
        buildInitialSituation();
        closeEntry(entry0);
