...
public class C60_01CopyAssignmentNonVirtualQuickFix extends RuleQuickFix {

    @Override
    public String getLabel() {
        final String problemId = getProblemId(marker);
        if (problemId.contentEquals(ProblemId.P_C60_01.getId())) {
            return Rule.C60 + ": Set to non-virtual";
        }
