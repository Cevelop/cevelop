...
public class ES46_01_06AvoidLossyIntToCharSmallFunctionArgumentConversionsQuickFixTest extends ES46_00AvoidLossyConversionsQuickFixTest {
    ...
    protected ES46LossyType getLossyType() {
        return ES46LossyType.IntToCharSmllFunc;
    }
}
