...
public class ProjectCoverageTest12GlobalVar2 extends IncludatorTest {
    ...
    public void runTest() throws Throwable {
        ...
        assertSuggestion(suggestions.get(i++), "A.cpp", inUseText, 16, 26); // int main() {
        assertSuggestion(suggestions.get(i++), "A.cpp", inUseText, 61, 4); // X x;
