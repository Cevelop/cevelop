...
public class ProjectCoverageTest15DestructorTest1 extends IncludatorTest {
    ...
    public void runTest() throws Throwable {
        ...
        assertSuggestion(suggestions.get(i++), "A.cpp", implicitlyInUseText, 28, 5); // ~X();
        assertSuggestion(suggestions.get(i++), "A.cpp", implicitlyInUseText, 38, 10); // X::X() { }
        assertSuggestion(suggestions.get(i++), "A.cpp", implicitlyInUseText, 50, 11); // X::~X() { }
        assertSuggestion(suggestions.get(i++), "A.cpp", inUseText, 0, 7); // class X
        assertSuggestion(suggestions.get(i++), "A.cpp", inUseText, 63, 21); // int main() {
    }
}
