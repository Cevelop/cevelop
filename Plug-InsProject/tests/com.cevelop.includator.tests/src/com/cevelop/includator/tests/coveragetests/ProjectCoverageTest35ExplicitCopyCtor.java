...
public class ProjectCoverageTest35ExplicitCopyCtor extends IncludatorTest {

    @Test
    public void runTest() throws Throwable {
        List<Suggestion<?>> suggestions = runAlgorithm(new StaticCoverageProjectAnalysisAlgorithm());

        Assert.assertEquals((Object) 16, (Object) suggestions.size());
        ...
        assertSuggestion(suggestions.get(i++), "A.cpp", inUseText, 210, 47); // int main() {
