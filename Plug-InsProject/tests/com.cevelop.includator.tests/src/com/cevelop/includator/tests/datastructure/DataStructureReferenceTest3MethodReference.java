...
public class DataStructureReferenceTest3MethodReference extends IncludatorTest {
    ...
    public void runTest() throws Throwable {
        ...
        assertDeclRefName("bar", reference);
        ...
        assertDeclaration(dependency.getDeclaration(), "C.h", "bar", 25);
    }
}
