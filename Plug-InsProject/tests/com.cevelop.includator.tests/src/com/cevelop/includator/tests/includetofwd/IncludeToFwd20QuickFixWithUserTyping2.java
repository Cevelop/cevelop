...
public class IncludeToFwd20QuickFixWithUserTyping2 extends IncludatorTest {
    ...
    public void runTest() throws Throwable {
        ...
        insertTextIntoActiveDocument(NL + "//blub", 43);
        insertTextIntoActiveDocument(NL + "//blub", 29);
        insertTextIntoActiveDocument("//blub" + NL, 0);
