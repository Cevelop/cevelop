...
public class IndexAdaptionTest2ExternalHeaderSimple extends IncludatorTest {
    ...
    public void runTest() throws Throwable {
        ...
        List<DeclarationReferenceDependency> dependencies = references.get(2).getRequiredDependencies();
        assertDeclRefDependencyExternalTargetFile("externalFrameworkTest/QWER.h", dependencies);
    }
}
