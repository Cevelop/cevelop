...
public class MarkerTest12PositionChangeTestUserTypingSaved extends IncludatorPositionTrackingChangeTest {
    ...
    public void runTest() throws Throwable {
        ...
        saveAllEditors(); // saving "user typing"
        assertPositionInfo(positionInfoToTest, newExpectedOffset);

        closeOpenEditors(); // already saved...
        openPrimaryTestFileInEditor();
