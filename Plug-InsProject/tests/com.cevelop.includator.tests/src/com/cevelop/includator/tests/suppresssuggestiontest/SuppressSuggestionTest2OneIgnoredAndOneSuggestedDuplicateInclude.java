...
public class SuppressSuggestionTest2OneIgnoredAndOneSuggestedDuplicateInclude extends IncludatorTest {
    ...
    public void runTest() throws Throwable {
        ...
        String expectedMsg = "Prevented adding of suggestion 'The include statement '#include \"A.h\"' is unneeded. Duplicate include.'" +
        ...
        assertSuggestion(suggestions.get(0), "main.cpp", "The include statement '#include \"B.h\"' is unneeded. Duplicate include.", 45, 14);
    }
}
